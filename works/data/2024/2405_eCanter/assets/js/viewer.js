$(function () {
	...
	$('.btn-start.is-stop').click(function(){
		...
		//カウント
		if (!$('.img-wrap').hasClass('is-pause')) {
			var initialStart = 0;
		} else {
			var restart_elmNum = $('.is-pause .draggable-area img').attr('src').slice(-6).slice(0,-4);
			initialStart = restart_elmNum;
		}
