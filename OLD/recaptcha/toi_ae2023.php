...
if ($recaptchaData->success) {
	...
	$url = 'https://go.shiro-k.jp/l/942883/2023-08-09/2g6b7q';
	$data = [];
	...
	$data['comment'] = trim($_REQUEST['comment']);
	// 送信データをURLエンコード
	...
	header('Location:https://go.shiro-k.jp/AE/thanks');
	exit();

} else {
	// reCAPTCHAが失敗した場合の処理
//	echo '失敗'.$recaptchaData->score.'<br>';

	header('Location:https://go.shiro-k.jp/AE/error');
	exit();
}
?>
